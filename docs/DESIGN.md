...
> Design notes for **transcript-action-pipeline** — a runnable python example that Process streaming transcript chunks with an OpenAI-compatible Python client.
...
- **Feature code** — the actual task: transcript-actions.
